...
class  Master:
    ...
    async def create_slave(self, args, **kwargs):
        ...
        if self.__create_slave_repo(args):
            if "password" in kwargs.keys():
                ...
                return await self.__update_master_index(args, access=kwargs.get("access"), password=kwargs.get('password'))
            else:
                self.__create_slave_index(args, access="public")
                return await self.__update_master_index(args, access="public")
        return False
    # ---------------------------- UPDATE ----------------------------------------

    async def __update_master_index(self, args, **kwargs):
        ...
        try:
            #print(data)
            return await updateIndex(data, self.handle('index'))            
        except Exception as e:
            return e
    
    async def clone_slave(self, args, **kwargs):
    ...
    async def destroy_slave(self, args, **kwargs):
